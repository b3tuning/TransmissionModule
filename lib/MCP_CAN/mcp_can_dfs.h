...
#ifndef TRANSCONTROLLER_MCP_CAN_DFS_H
#define TRANSCONTROLLER_MCP_CAN_DFS_H
...
#define MCP_TX01_INT        0x0C      /* Enable TXB0 and TXB1 interrupt pts */
...
#endif //TRANSCONTROLLER_MCP_CAN_DFS_H
